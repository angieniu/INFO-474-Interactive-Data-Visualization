      ...
      .append('circle')
        ...
        .on("mouseover", (d) => {
          div.transition()
            .duration(200)
            .style("opacity", .9);
          div.html("Country: " + d.location + "<br/>" + "Year: " + d.time + "<br/>" + "Life Expectancy: " + d.life_expectancy + "<br/>" + "Fertility: " + d.fertility_rate + "<br/>" + "Populartion: " + numberWithCommas(d["pop_mlns"]*1000000))
